...
def generate_launch_description():
    """Launch 4-wheel skid-steer system compatible with Nav2"""
    ...
    # 4-Wheel Skid-Steer Controller for Nav2
    skid_steer_controller = Node(
        package='vesc_driver',
        executable='vesc_skid_steer_node',
        ...
        remappings=[
            ('cmd_vel', '/cmd_vel'),        # Nav2 command input
            ('odom', '/odom'),              # Nav2 odometry output
        ],
        output='screen',
        emulate_tty=True
    )
